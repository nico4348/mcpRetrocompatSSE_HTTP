...
export function metodosPagoProfesionalesTool(server: McpServer) {
	server.tool(
		"metodosPagoProfesionales",
		`
        Información sobre los métodos de pago para los programas profesionales.
        `,
		async () => {
			return {
				content: [
					{
						type: "text",
						text: `
                    Métodos de Pago para los Programas Profesionales
