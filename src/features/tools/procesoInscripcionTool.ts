...
La inscripción está abierta todo el año y es completamente gratuita, sin ningún costo adicional. Al inscribirte en cualquier momento, podrás acceder a beneficios exclusivos como descuentos especiales y prioridad en la asignación de tu jornada preferida.
...
Siguiente Paso
Una vez completes tu inscripción, recibirás en los próximos días un enlace para tu entrevista virtual con los directivos de la universidad. Es fundamental que asistas a esta entrevista.
                    `,
					},
				],
			};
