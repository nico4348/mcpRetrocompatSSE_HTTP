...
export function metodosPagoTecnicosTool(server: McpServer) {
	server.tool(
		"metodosPagoTecnicos",
		`
        Información sobre los métodos de pago para los técnicos laborales.
        `,
		async () => {
			return {
				content: [
					{
						type: "text",
						text: `
                    Métodos de Pago para los técnicos laborales
...
3. Datáfono en la Sede Principal
   ...
   Se recibe pago por datafono, solo se acepta VISA, MasterCard, tarjeta débito y crédito.
